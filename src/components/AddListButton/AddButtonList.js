    ...
    return (
        <div className="add-list">
            ...
            <List onClick ={() => setState(true)}
                ...
                </svg>, name: "Добавить список", className: "List__add-button"}
                ]}/>

                {state && <div className="add-list__popap">
                    <input className="field" type="text" placeholder="Название папки"></input>
                    <div className="badge">

                    {props.colors.map((color) => {
                        return (
                                <Badge item={color.name}/>
                        )
                    })}
                    </div>
